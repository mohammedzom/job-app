<x-app-layout>
    ...
    <style>
        ...
        .jv-back-link:hover { color: #a5b4fc; gap: 0.6rem; }
        .jv-back-link svg { width: 16px; height: 16px; }
        ...
        .jv-apply-btn svg { width: 18px; height: 18px; }
        ...
        @media (max-width: 900px) {
            .jv-body { grid-template-columns: 1fr; }
        }
        ...
        .overview-item .label svg { width: 14px; height: 14px; opacity: .75; }
        .overview-item .value {
            font-size: 0.9rem;
            font-weight: 600;
            color: #e2e8f0;
        ...
        /* ── Tag pills ─────────────────────────────────── */
        .tag-group { display: flex; flex-wrap: wrap; gap: 0.45rem; margin-top: 0.5rem; }
        .tag-pill {
            font-size: 0.75rem;
            font-weight: 600;
        ...
        .deadline-badge svg { width: 14px; height: 14px; }
    </style>
                ...
                <div>
                    ...
                    <div class="jv-meta-row">
                        <span class="jv-chip jv-chip-location">
                            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" width="13" height="13"><path d="M12 21s-8-7.5-8-13a8 8 0 0116 0c0 5.5-8 13-8 13z"/><circle cx="12" cy="8" r="3"/></svg>
                            {{ $jobVacancy->location }}
                        </span>
                        <span class="jv-chip jv-chip-salary">
                            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" width="13" height="13"><rect x="2" y="7" width="20" height="14" rx="2"/><path d="M16 7V5a2 2 0 00-2-2h-4a2 2 0 00-2 2v2"/><line x1="12" y1="12" x2="12" y2="16"/><line x1="10" y1="14" x2="14" y2="14"/></svg>
                        ...
                        @if ($jobVacancy->status === 'active')
                            <span class="jv-chip jv-chip-status-active">
                                <svg viewBox="0 0 10 10" width="7" height="7" fill="currentColor"><circle cx="5" cy="5" r="5"/></svg>
                                Active
                            </span>
                        @endif
                    </div>
            ...
            <div style="display:flex; flex-direction:column; gap:1.25rem;">
                ...
                <div class="jv-card" style="padding:1.4rem;">
                    ...
                    @if ($jobVacancy->view_count > 0)
                        ...
                        @endphp
                        <div style="background:rgba(99,102,241,.07);border-radius:.7rem;padding:.7rem 1rem;text-align:center;">
                            <div style="font-size:.7rem;color:#64748b;text-transform:uppercase;letter-spacing:.06em;font-weight:500;margin-bottom:.2rem;">Conversion Rate</div>
                ...
                {{-- CTA bottom --}}
                <a href="{{ route('job-vacancies.apply', $jobVacancy->id) }}" class="jv-apply-btn" style="justify-content:center; border-radius:0.85rem; text-align:center;">
