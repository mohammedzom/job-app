<x-main-layout title="Shaghalni - Find Your Dream Job">
    ...
    <style>
        ...
        .hero-badge    { animation: fadeDown  .6s cubic-bezier(.22,1,.36,1) .15s both; }
        .hero-heading  { animation: scaleFade .8s cubic-bezier(.22,1,.36,1) .3s  both; }
        .hero-desc     { animation: fadeUp    .7s cubic-bezier(.22,1,.36,1) .5s  both; }
        .hero-buttons  { animation: fadeUp    .7s cubic-bezier(.22,1,.36,1) .65s both; }
